...
import koreanlearning.hangul.serokorean.view.main.bottomNavigation.acknowlegement.AcknowledgementActivity;
import koreanlearning.hangul.serokorean.view.main.bottomNavigation.challenge.ChallengeActivity;
import koreanlearning.hangul.serokorean.view.main.profile.ProfileActivity;
...
//        }
        ...
        bookmarkbox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent acknowledgement = new Intent(getActivity(), ChallengeActivity.class);
                startActivity(acknowledgement);
            }
        });
